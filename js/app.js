...
(function () {
  ...
  const NAV = ["countdown", "timer", "verbal", "wrongwords", "data", "logic", "relation", "politics", "quantity", "common", "essay", "essays", "allusion", "calendar", "wrongbook", "stats", "pdfimport", "ai", "settings"];
